...
class FangZfSpider(CrawlSpider):
    ...
    start_urls = ['https://cs.zu.fang.com/house-a013283/i32/']

    rules = (
        # Rule(LinkExtractor(allow=r'/house-a\d/'), restrict_xpaths='//dd[@style='position']/a' ,callback='parse_item', follow=True),
        Rule(LinkExtractor(allow=r'/house-a', restrict_xpaths="//div[@class='fanye']/a"), callback='parse_item', follow=True),
    )
